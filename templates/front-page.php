...
<section class="mt-[36px] lg:mt-[64px]" id="works">
    <div class="container mx-auto px-3">
        <div class="flex flex-wrap items-start justify-between gap-4 w-[100%]">
            ...
            <a href="/" class="text-xs lg:text-xl font-medium text-black border-2 border-[#20436C] rounded-[24px] lg:rounded-[44px] px-[16px] py-[6px] lg:px-[28px] lg:py-[12px] transition hover:text-[#20436C]" title="Подробнее">Подробнее</a>
        </div>
    </div>
</section>
