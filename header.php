...
<body <?php body_class('min-h-screen flex flex-col'); ?>>
    <header class="pt-[14px] pb-[14px] lg:pb-[0px] bg-[#20436C] sticky top-0 z-40">
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center lg:border-r border-white lg:pr-4 lg:me-4 w-[90px] sm:w-auto">
                            <a href="<?php echo home_url(); ?>"
                                class="inline-block w-[156px] bg-white rounded-[8px] py-[4px] px-[8px] transition hover:-translate-y-[2px]"
